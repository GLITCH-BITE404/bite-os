...
QtObject {
    ...
    readonly property list<QtObject> panes: [
        ...
        QtObject {
            readonly property string id: "dots"
            readonly property string label: "dots"
            readonly property string icon: "extension"
            readonly property string component: "dots/DotsPane.qml"
        }
    ]
